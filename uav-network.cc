...
UavNetwork::UavNetwork() //: m_filePacketServer(global_path << "/data/output/packet_trace_server.txt"), m_filePacketUav(global_path << "/data/output/packet_trace_uav.txt"), m_filePacketClient(global_path << "/data/output/packet_trace_client.txt")
{
...
void UavNetwork::Run()
{
  ...
  m_pathData = ss.str();
  ss.str("");
  ss << "rm -Rf " << global_path << "/data/output/" << m_pathData;
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData;
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/course_changed";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_remaining_energy";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_hover";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_move";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_energy_threshold";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/etapa";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_recharged";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_depletion";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_client";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_wifi";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/uav_stop";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/python";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/dhcp";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/client";
  system(ss.str().c_str());
  ss.str("");
  ss << "mkdir -p " << global_path << "/data/output/" << m_pathData << "/compare";
  system(ss.str().c_str());
  // ss.str("");
  // ss << global_path << "/data/output/"<< m_pathData<<"/packet_trace_server.txt";
  // m_filePacketServer = ss.str().c_str();
  // ss.str("");
  // ss << global_path << "/data/output/"<<m_pathData<<"/packet_trace_uav.txt";
  // m_filePacketUav = ss.str().c_str();
  // ss.str("");
  // ss << global_path << "/data/output/"<<m_pathData<<"/packet_trace_client.txt";
...
void UavNetwork::NewUav(int total, int update) // update = 0- normal 1- supply 2-depletion
{
  ...
  while (total--) {
    ...
    os << global_path << "/data/output/" << m_pathData << "/uav_network_log.txt";
...
void UavNetwork::RemoveUav(int id, int step)
{
  ...
  os.str("");
  os << global_path << "/data/output/" << m_pathData << "/etapa/" << step << "/uav_removed_energy.txt";
  m_file.open(os.str(), std::ofstream::out | std::ofstream::app);
...
{ // escolhe a aplicacao que o usuario ira criar quando em conexao!!
  ...
  {
    ss.str("");
    ss << global_path << "/data/output/" << m_pathData << "/wifi/client_" << (*i)->GetId() << ".txt";
...
void UavNetwork::PrintUavEnergy (int t)
{
  ...
  std::ostringstream os;
  os << global_path << "/data/output/" << m_pathData << "/etapa/" << t << "/uav_energy.txt";
  std::ofstream file;

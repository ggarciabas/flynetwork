...
for seed_name in glob.glob(main_path+'*/'):
    ...
    ax = sns.boxplot(x="COST", y="U1", data=df_seed, showfliers=False)
    lgd = ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.15), fancybox=True, shadow=True, ncol=2)
    plt.xlabel("Custo")
    plt.ylabel(u"$(B_{t}^{u_i}-B_{a}^{u_i}) / B_{t}^{u_i}$")
    # plt.show()
    ...
    ax = sns.boxplot(x="COST", y="D1", data=df_seed, showfliers=False)
    lgd = ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.15), fancybox=True, shadow=True, ncol=2)
    plt.xlabel("Custo")
    plt.ylabel(u"$B_{a}^{u_i} / B_{t}^{u_i}$")
    # plt.show()
...
ax = sns.pointplot(x="COST", y="U1", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$(B_{t}^{u_i}-B_{a}^{u_i}) / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/u1.svg")
plt.savefig("./output/"+scenario+"/u1_pointplot.eps")
# plt.savefig("./output/"+scenario+"/u1.png")
plt.close()

ax = sns.pointplot(x="COST", y="D1", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$B_{a}^{u_i} / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/d1.svg")
plt.savefig("./output/"+scenario+"/d1_pointplot.eps")
# plt.savefig("./output/"+scenario+"/d1.png")
plt.close()
...
ax = sns.boxplot(x="COST", y="W1", data=df_main, showfliers=False)
plt.xlabel("Custo")
plt.ylabel(u"$ECw_{u_i} / (B_{t}^{u_i}-B_{a}^{u_i})$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/w1.svg")
plt.savefig("./output/"+scenario+"/w1_nout.eps")
# plt.savefig("./output/"+scenario+"/w1.png")
plt.close()

ax = sns.pointplot(x="COST", y="W1", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$ECw_{u_i} / (B_{t}^{u_i}-B_{a}^{u_i})$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/w1.svg")
plt.savefig("./output/"+scenario+"/w1_pointplot.eps")
# plt.savefig("./output/"+scenario+"/w1.png")
plt.close()
...
ax = sns.pointplot(x="COST", y="W2", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$ECw_{u_i} / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/w2.svg")
plt.savefig("./output/"+scenario+"/w2_pointplot.eps")
# plt.savefig("./output/"+scenario+"/w2.png")
plt.close()

ax = sns.boxplot(x="COST", y="W2", data=df_main, showfliers=False)
plt.xlabel("Custo")
plt.ylabel(u"$ECw_{u_i} / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/w2_nout.svg")
plt.savefig("./output/"+scenario+"/w2_nout.eps")
# plt.savefig("./output/"+scenario+"/w2.png")
plt.close()
...
ax = sns.pointplot(x="COST", y="M1", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$ECm_{u_i} / (B_{t}^{u_i}-B_{a}^{u_i})$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/m1.svg")
plt.savefig("./output/"+scenario+"/m1_pointplot.eps")
# plt.savefig("./output/"+scenario+"/m1.png")
plt.close()


ax = sns.boxplot(x="COST", y="M1", data=df_main, showfliers=False)
plt.xlabel("Custo")
plt.ylabel(u"$ECm_{u_i} / (B_{t}^{u_i}-B_{a}^{u_i})$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/m1.svg")
plt.savefig("./output/"+scenario+"/m1_nout.eps")
# plt.savefig("./output/"+scenario+"/m1.png")
plt.close()
...
ax = sns.pointplot(x="COST", y="M2", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$ECm_{u_i} / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/m2.svg")
plt.savefig("./output/"+scenario+"/m2_pointplot.eps")
# plt.savefig("./output/"+scenario+"/m2.png")
plt.close()

ax = sns.boxplot(x="COST", y="M2", data=df_main, showfliers=False)
plt.xlabel("Custo")
plt.ylabel(u"$ECm_{u_i} / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/m2.svg")
plt.savefig("./output/"+scenario+"/m2_nout.eps")
# plt.savefig("./output/"+scenario+"/m2.png")
plt.close()
...
ax = sns.pointplot(x="COST", y="H1", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$ECh_{u_i} / (B_{t}^{u_i}-B_{a}^{u_i})$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/h1.svg")
plt.savefig("./output/"+scenario+"/h1_pointplot.eps")
# plt.savefig("./output/"+scenario+"/h1.png")
plt.close()

ax = sns.boxplot(x="COST", y="H1", data=df_main, showfliers=False)
plt.xlabel("Custo")
plt.ylabel(u"$ECh_{u_i} / (B_{t}^{u_i}-B_{a}^{u_i})$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/h1.svg")
plt.savefig("./output/"+scenario+"/h1_nout.eps")
# plt.savefig("./output/"+scenario+"/h1.png")
plt.close()
...
ax = sns.pointplot(x="COST", y="H2", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"$ECh_{u_i} / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/h2.svg")
plt.savefig("./output/"+scenario+"/h2_pointplot.eps")
# plt.savefig("./output/"+scenario+"/h2.png")
plt.close()

ax = sns.boxplot(x="COST", y="H2", data=df_main, showfliers=False)
plt.xlabel("Custo")
plt.ylabel(u"$ECh_{u_i} / B_{t}^{u_i}$")
# plt.show()
# #plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/h2.svg")
plt.savefig("./output/"+scenario+"/h2_nout.eps")
# plt.savefig("./output/"+scenario+"/h2.png")
plt.close()

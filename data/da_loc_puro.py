...
path = sys.argv[1]
main_path = "./scratch/client/data/output/"+path
etapa = sys.argv[2]
iteracao = sys.argv[3]
rcob = sys.argv[4]
da = "puro"
...
for arquivo in glob.glob(main_path+'/'+'etapa/'+etapa+'/da_loc_'+da+'_*'+iteracao+'.txt'):
    ...
    plt.savefig(main_path+'/'+'etapa/'+etapa+'/da_loc_'+da+'_{:015}'.format(int(iteracao))+'.png', bbox_extra_artists=(lgd,), bbox_inches='tight')

...
ax = sns.pointplot(x="COST", y="DT", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"Tempo desconectado (%)")
# plt.show()
# plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
...
ax = sns.pointplot(x="COST", y="TAX", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"Desc.Time/Con.Time")
# plt.show()
# plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')
# plt.savefig("./output/"+scenario+"/tax_time.svg")
plt.savefig("./output/"+scenario+"/tax_time_pointplot.eps")
# plt.savefig("./output/"+scenario+"/tax_time.png")
plt.close()
...
ax = sns.pointplot(x="COST", y="CT", data=df_main)
plt.xlabel("Custo")
plt.ylabel(u"Tempo conectado (%)")
# plt.show()
# plt.title("Comparação tempo de", fontsize=13, fontweight=0, color='black', style='italic')

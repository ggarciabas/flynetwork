...
protocol = sys.argv[2] # Protocol

it = sys.argv[3] # iteration from DA
...
for seed_name in glob.glob(main_path+'*/'):
    ...
    for custo_name in glob.glob(main_path+seed+'/'+protocol+'/custo_*/'):
        ...
        for etapa_name in glob.glob(main_path+seed+'/'+protocol+'/'+custo+'/etapa/*/'):
            etapa = os.path.dirname(etapa_name).split('/')[-1]
            path = main_path+seed+'/'+protocol
            # print "DA LOc - new Graphic"
            f_cen = open(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/client.txt','r')
            line = f_cen.readline().strip()
            cli = [x for x in line.split(',')]
            f_cen.close()
            arquivos = glob.glob(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_'+da+'_*.txt')
            ...
            for i in np.arange(0, len(arquivos), 1):
                ...
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_'+da+'_{:015}'.format(int(iteracao[0]))+'.svg', bbox_extra_artists=(lgd,), bbox_inches='tight')
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_'+da+'_{:015}'.format(int(iteracao[0]))+'.eps', bbox_extra_artists=(lgd,), bbox_inches='tight')
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_scenario'+da+'_{:015}'.format(int(iteracao[0]))+'.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
                ...
                plt.tight_layout()
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_'+da+'_{:015}'.format(int(iteracao[0]))+'.png')
                plt.close()
                ...
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_hist_'+da+'_{:015}'.format(int(iteracao[0]))+'.svg')
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_hist_'+da+'_{:015}'.format(int(iteracao[0]))+'.eps')
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/da_loc_hist_'+da+'_{:015}'.format(int(iteracao[0]))+'.png')
                plt.close()
                ...
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/client_dr_'+da+'_{:015}'.format(int(iteracao[0]))+'.svg')
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/client_dr_'+da+'_{:015}'.format(int(iteracao[0]))+'.eps')
                plt.savefig(path+'/'+str(custo)+'/etapa/'+str(etapa)+'/client_dr_'+da+'_{:015}'.format(int(iteracao[0]))+'.png')
                plt.close()
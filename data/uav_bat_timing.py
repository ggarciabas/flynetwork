...
for seed_name in glob.glob(main_path+'*/'):
    ...
    # df_seed_timing.to_pickle("./output/"+scenario+"/"+seed+"/df_seed_timing.pkl")

df_main = df_main.sort_values(["TIME", "COST"])
if teste:
    print "Final sorted main data: "+str(df_main)

fig1 = plt.figure(1)
ax1 = fig1.add_subplot(111)
ax1 = sns.lineplot(x="TIME", y="W1", data=df_main, hue="COST", ax = ax1)
lgd = ax1.legend(loc='upper center', bbox_to_anchor=(0.5, 1.15), fancybox=True, shadow=True, ncol=2)
...
ax2 = sns.lineplot(x="TIME", y="W2", data=df_main, hue="COST", ax=ax2)
lgd = ax2.legend(loc='upper center', bbox_to_anchor=(0.5, 1.15), fancybox=True, shadow=True, ncol=2)

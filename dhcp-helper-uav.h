...
#ifndef DHCP_HELPER_UAV_H
#define DHCP_HELPER_UAV_H
...
public:
   ...
   */
  ApplicationContainer InstallDhcpServerUav (Ptr<NetDevice> netDevice, Ipv4Address serverAddr,
